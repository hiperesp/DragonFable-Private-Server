...
- **ID**: 1064
- **Name**: Bunod
- **Description**: This wand is named for the ancient word for Dark magic. It&#039;s the type of wand used by the noctomancers of Swordhaven, but it&#039;s been magically altered to leave other weapons in the dark.
...
- **SWF File**: items/wands/wand-dark.swf
- **Icon**: wand
