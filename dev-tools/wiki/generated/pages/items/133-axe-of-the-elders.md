...
- **ID**: 133
- **Name**: Axe of the Elders
- **Description**: An axe that has existed for uncounted generations. Its name pops up in ancient legends from time to time.
...
- **SWF File**: items/axes/axe-stone.swf
- **Icon**: axe
