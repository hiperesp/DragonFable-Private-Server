...
- **ID**: 395
- **Name**: Givest, the Earthblade
- **Description**: This named blade was forged using magic and heat from the heart of the world, and is made from rare metals only found deep underground.
...
- **SWF File**: items/swords/sword-silvergem.swf
- **Icon**: sword
