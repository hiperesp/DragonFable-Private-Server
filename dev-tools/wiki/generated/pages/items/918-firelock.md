...
- **ID**: 918
- **Name**: Firelock
- **Description**: This item requires a Dragon Amulet. The source of its power is the fire gem set into the molten gold within the staff&#039;s head. 
...
- **SWF File**: items/staffs/staff-fireflame1-r4.swf
- **Icon**: staff
